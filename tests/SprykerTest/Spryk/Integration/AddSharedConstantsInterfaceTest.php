...
{
    protected const SPRYK_NAME = 'AddSharedConstantsInterface';
    ...
    public function testAddsSharedConstantsInterfaceFile(): void
    {
        ...
        $this->assertFileExists($this->tester->getModuleDirectory() . 'src/Spryker/Shared/FooBar/FooBarConstants.php');
    }
}
