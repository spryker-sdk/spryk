...
class AddZedPersistenceEntityManagerInterfaceTest extends Unit
{
    ...
    public function testAddsZedEntityManagerInterfaceFile(): void
    {
        ...
        $this->assertFileExists($this->tester->getSprykerModuleDirectory() . 'src/Spryker/Zed/FooBar/Persistence/FooBarEntityManagerInterface.php');
    }

    /**
     * @return void
     */
    public function testAddsZedEntityManagerInterfaceFileOnProjectLayer(): void
    {
        $this->tester->run($this, [
            '--module' => 'FooBar',
            '--mode' => 'project',
