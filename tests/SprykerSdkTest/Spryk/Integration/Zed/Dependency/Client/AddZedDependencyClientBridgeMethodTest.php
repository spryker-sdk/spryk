...
class AddZedDependencyClientBridgeMethodTest extends Unit
{
     ...
     * @return void
     */
    public function testTryToAddZedDependencyClientBridgeMethodsOnProjectLevelThrowsException(): void
    {
     ...
     * @return void
     */
    public function testTryToAddZedDependencyClientBridgeMethodOnlyOnceOnProjectLevelThrowsException(): void
    {
        $this->expectException(SprykWrongDevelopmentLayerException::class);
