...
class AddClientDependencyClientBridgeTest extends Unit
{
    ...
    public function testAddsClientDependencyClientBridge(): void
    {
        ...
        $this->assertFileExists($this->tester->getModuleDirectory() . 'src/Spryker/Client/FooBar/Dependency/Client/FooBarToZipZapClientBridge.php');
    }

    /**
     * @return void
     */
    public function testAddsClientDependencyClientBridgeOnProjectLayer(): void
    {
