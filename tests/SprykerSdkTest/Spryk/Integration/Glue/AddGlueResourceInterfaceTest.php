...
class AddGlueResourceInterfaceTest extends Unit
{
    ...
    public function testAddsGlueResourceInterface(): void
    {
        ...
        static::assertFileExists($this->tester->getModuleDirectory() . 'src/Spryker/Glue/FooBar/BarResourceInterface.php');
    }
    ...
    public function testAddsGlueResourceInterfaceOnProjectLayer(): void
    {
        ...
        static::assertFileExists($this->tester->getProjectModuleDirectory('FooBar', 'Glue') . 'BarResourceInterface.php');
    }
}
