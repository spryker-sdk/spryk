...
class AddGlueResourceRestResponseBuilderModelTest extends Unit
{
    ...
    public function testAddsGlueProcessorModelInterface(): void
    {
        ...
        static::assertFileExists($this->tester->getModuleDirectory() . 'src/Spryker/Glue/FooBar/Processor/RestResponseBuilder/FooBarRestResponseBuilder.php');
    ...
    public function testAddsZedBusinessModelInterfaceOnProjectLayer(): void
    {
        ...
        static::assertFileExists($this->tester->getProjectModuleDirectory('FooBar', 'Glue') . 'Processor/RestResponseBuilder/FooBarRestResponseBuilder.php');
