 ...
 * @group Yves
 * @group RouteProvider
 * @group AddYvesRouteProviderTest
 * Add your own group annotations below this line
 */
class AddYvesRouteProviderTest extends Unit
{
    /**
     ...
     * @return void
     */
    public function testAddsYvesRouteProviderPluginFile(): void
    {
     ...
     * @return void
     */
    public function testAddsYvesRouteProviderPluginFileOnProjectLayer(): void
    {
        $this->tester->run($this, [
            '--module' => 'FooBar',
            '--mode' => 'project',
