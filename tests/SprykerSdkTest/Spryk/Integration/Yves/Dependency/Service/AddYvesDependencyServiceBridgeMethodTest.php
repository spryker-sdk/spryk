...
class AddYvesDependencyServiceBridgeMethodTest extends Unit
{
     ...
     * @return void
     */
    public function testTryToAddYvesDependencyServiceBridgeMethodsOnProjectLevelThrowsException(): void
    {
     ...
     * @return void
     */
    public function testTryToAddYvesDependencyServiceBridgeMethodOnlyOnceOnProjectLevelThrowsException(): void
    {
        $this->expectException(SprykWrongDevelopmentLayerException::class);
